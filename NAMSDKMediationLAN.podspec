...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/naver/nam-sdk-ios", :tag => "LAN-#{s.version.to_s}" }
  
  s.vendored_frameworks = "AdMediationSDK/LAN/GFPSDKMediationLAN.xcframework"

  s.dependency 'NAMSDK/GFPSDK', '>= 8.20.0'
  s.dependency 'FiveAd', '3.0.1'
