...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/naver/nam-sdk-ios", :tag => "Pangle-#{s.version.to_s}" }
  
  s.vendored_frameworks = "AdMediationSDK/Pangle/GFPSDKMediationPangle.xcframework"
