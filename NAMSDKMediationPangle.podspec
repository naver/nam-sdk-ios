...
Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = "MediationSDK/Pangle/#{s.version.to_s}/GFPSDKMediationPangle.xcframework"

  s.dependency 'NAMSDK/GFPSDK', '>= 8.13.0'
  s.dependency 'Ads-Global', '7.6.0.6'
