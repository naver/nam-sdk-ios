//
//  SettingAdParamViewController.swift
//
...
class SettingAdParamViewController: UITableViewController, SettingSliderTableViewCellDelegate, SettingSwitchTableViewCellDelegate {
    
    private let manager : SettingConfigManager
    
    init() {
        self.manager = SettingConfigManager()
    ...
    private func setupView() {
        self.title = NSLocalizedString("Setting_Ad_Param_Title", comment: "")
