 ...
 */
@interface OMIDNavercorpAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDNavercorpAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDNavercorpVASTProperties *_Nonnull)vastProperties
