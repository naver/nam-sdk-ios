 ...
 */
@interface OMIDNavercorpAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDNavercorpAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDNavercorpAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDNavercorpAdSessionContext *)context
