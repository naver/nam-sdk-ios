 ...
 * Amazon DTBAdResponse 의 customTargeting 에 해당.
 */
...
/**
 * Amazon DTBAdResponse 의 mediationHints.
 */
@property (readwrite, nonatomic, copy, nullable) NSDictionary *mediationHints;
