...
- (void)reportTrackingViewableImp:(NSString * _Nonnull)aURL;
- (void)reportTrackingRenderedImp:(NSString * _Nonnull)aURL;
- (void)reportTrackingAttachedImp:(NSString * _Nonnull)aURL;
- (void)reportTrackingClickEvent:(NSString * _Nonnull)aURL;
- (void)reportTrackingMuteEvent:(NSString * _Nonnull)aURL;
...
+ (void)sendGFPEventToUrl:(NSString * _Nonnull)urlString;
