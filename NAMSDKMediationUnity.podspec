...
Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = "MediationSDK/Unity/#{s.version.to_s}/GFPSDKMediationUnity.xcframework"

  s.dependency 'NAMSDK/GFPSDK', '>= 8.11.4'
  s.dependency 'UnityAds', '4.16.1'
