...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/naver/nam-sdk-ios", :tag => "IronSource-#{s.version.to_s}" }

  s.vendored_frameworks = "AdMediationSDK/IronSource/GFPSDKMediationIronSource.xcframework"
